#I got this list from : https://github.com/matthlavacka/car-list/blob/master/car-list.json

carsList = [{"brand": "Seat", "models": ["Alhambra", "Altea", "Altea XL", "Arosa", "Cordoba", "Cordoba Vario", "Exeo", "Ibiza", "Ibiza ST", "Exeo ST", "Leon", "Leon ST", "Inca", "Mii", "Toledo"]},
...
for item in carsList:
    ...
    models = models + item["models"]

#adding some models that are in the dataset but not in the list
brands.extend(["ssangyong","skoda", "gmc", "vaz", "cadillac", "greatwall", "buick", "uaz", "scion", "lincoln", "rolls-royce", "citroen", "pontiac", "acura", "daihatsu", "moskvich", "gaz", "mercury"])
models.extend([
    "presage rider", "330", "328", "616", "528", "rav 4", "520", "yukon", "chr", "veracruz", 
    "altima", "kicks sr", "es 300", "venza", "chr", "ist", "ml 350", "ats", "clk 230", "clk 320", 
    "skyline 4wd", "viano", "ml 350", "ml 320", "300", "2121", "coltplus plus", "500c", 
    "elysion", "hs 250h", "vitz", "225", "ml 320", "durango", "isis", "325", "sintra", "niro", "gonow", 
    "lafesta", "crosstrek", "b 170", "skyline", "wizard", "fuga", "xd", "step wagon", "viano", "combo", 
    "altezza", "ia isti", "elgrand", "teana", "ramcharger", "tlx", "kona", "740", "sentra", "rav 4", 
    "impala", "axela", "sienna", "town car", "vaneo", "forte", "b 180", "sentra", "mirage", "gti", 
    "escudo", "cts", "megane", "370z", "mark x zio", "century", "viano", "xl7 limited", "vitz", "sienna", 
    "ml 350", "350", "220", "510", "terra", "ml 350", "bmw 7 series", "g37", "passo", "latio", "yrv", 
    "m550", "4runner", "rav 4 xle", "allroad", "vitz rs", "enclave", "navigator", "sienna", "mirage"])

# after removing the models that are not in the dataset to make the method faster 
models = ['6', 'unknown', 'H1', 'Corsa', 'Outback', 'IS', 'E', 'S', 'X6',
       'XJ', 'A', 'Elantra', 'presage rider', 'Prius', 'Golf', 'Transit',
       'Astra', 'Focus', 'Insight', 'RX', 'Camry', 'Highlander', '330',
       'Corolla', 'C', 'Forester', 'Pathfinder', 'Optima', 'Fiesta',
       'RS7', 'Sonata', 'Vectra', '328', 'X5', 'GLA', 'Tucson', 'Zafira',
       'GT', 'Cayenne', '616', '528', 'Captiva', '3', 'Santa Fe',
       'ml 350', 'Orlando', 'rav 4', 'GX', 'terra', 'Jetta', 'Aveo',
       'CX-7', 'GLE', '520', 'Land Cruiser', 'yukon', 'LS', 'CX-9',
       'Outlander', 'Octavia', 'Civic', 'CT', 'Picanto', 'chr', 'Compass',
       'Sprinter', 'veracruz', 'CR-V', 'Pajero', 'altima', 'kicks sr',
       'Cruze', 'Sharan', 'es 300', 'Equinox', 'Fusion', '500', 'Polo',
       'Touareg', 'Q7', 'Juke', 'Crafter', 'venza', 'ist', 'A4',
       'Lacetti', 'GL', 'Malibu', 'Cherokee', 'Cooper', 'Tiguan',
       'Countryman', 'Mustang', '206', 'Genesis', 'clk 230', 'clk 320',
       'vitz', 'ats', '323', 'CLS', 'Z4', 'Spark', 'HR-V', 'Serena',
       'skyline 4wd', 'viano', 'i30', '240', 'Leon', '416',
       'Grand Vitara', 'ml 320', 'RX-8', 'Accent', 'combo', '300', '2121',
       'coltplus plus', 'Meriva', 'Carnival', '500c', 'A6', 'Impreza',
       '500L', 'elysion', 'hs 250h', 'Passat', '225', 'Soul', 'Neon',
       'Sorento', 'cts', 'Tourneo Connect', 'CL', 'Avenger', '406', 'A7',
       'sintra', 'niro', 'Cerato', 'X1', 'Grandeur', 'gonow', 'lafesta',
       'CR-Z', 'crosstrek', 'XV', 'b 170', '147', 'Camaro', 'Tundra',
       'Sportage', 'Legacy', 'MPV', 'Tiida', 'A3', '307', 'M5', 'Demio',
       'Note', 'M', 'G', 'impala', 'X-Trail', 'Laguna', 'Murano',
       'durango', 'C30', 'isis', '325', 'century', 'Grandis', 'Jimny',
       'CLA', '159', 'Latitude', 'Renegade', 'Escort', 'forte', 'A5',
       'Hilux', 'RAM', 'skyline', 'Rio', 'Maxima', 'wizard', 'Q5', 'Edge',
       '2', 'fuga', 'xd', 'X3', '200', 'step wagon', 'Sequoia', 'NX',
       'Lantra', 'Micra', 'Samurai', 'Captur', 'CC', 'Omega', '100',
       'Colt', 'Wrangler', 'Clio', 'SX4', 'altezza', 'ia isti', 'elgrand',
       'Vitara', 'Getz', 'Avensis', 'V50', 'Veloster', 'Yaris', 'Ka',
       'Kizashi', 'Nubira', 'Caddy', 'X4', 'GS', 'navigator', 'mirage',
       '5', 'Caliber', 'Trax', 'sienna', 'C8', 'HHR', 'A8', 'C5',
       'sentra', 'Avella', 'Accord', 'S40', 'Panamera', 'vaneo', 'axela',
       'Explorer', 'b 180', 'Seicento', 'Discovery', '115', 'Beetle',
       'Patrol', 'ix35', '350', '4runner', 'Challenger', 'teana',
       'Kangoo', 'ramcharger', 'tlx', 'kona', 'Corvette', '740', 'Doblo',
       'Panda', 'passo', 'Mondeo', 'RC F', 'xl7 limited', 'Charger',
       'SLK', 'town car', 'XF', 'gti', 'escudo', 'megane', '370z',
       'mark x zio', 'M4', 'Galant', 'i40', 'LX', 'Lancer', 'Q3', 'Verso',
       'Berlingo', 'Premacy', 'Swift', 'Suburban', 'Integra', 'Journey',
       'g37', 'latio', 'yrv', 'Matiz', 'm550', 'Fabia', 'Frontera',
       'allroad', 'enclave', 'X-Type']
